                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading"> Insert Product Category</div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="/kategori" method="post">
                                        ...
                                        {{ csrf_field() }}
                                        <div class="form-body">
                                            <h3 class="box-title">About Product Category</h3>
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label">Product Category</label>
                                                        <input name="category_name" type="text" id="firstName" class="form-control" placeholder="Name"> </div>
                                                </div>
                                            </div> 
                                            <hr></div>
                                ...
                                <table class="table product-overview" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 12%">
                                                <div class="col-md-6">
                                                    <form method='GET' action='kategori/{{$row->id}}/edit'>
                                                        {{ csrf_field() }}
                                                        {{-- <a href="kategori/{{$row->id}}/edit" class="text-inverse p-r-10" data-toggle="tooltip" title="Edit"><i class="ti-marker-alt"></i></a> --}}
                                                ...
                                                <div class="col-md-6">
                                                    <form method='post' action='kategori/{{$row->id}}'>
                                                        {{ method_field('DELETE') }}
                                                        {{ csrf_field() }}
                                                        {{-- <a href="kategori/{{$row->id}}" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="ti-trash"></i></a> --}}
