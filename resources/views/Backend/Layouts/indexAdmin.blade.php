    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="index.html"><b>
                    <!--This is dark logo icon--><img src="{{asset('asset/plugins/images/eliteadmin-logo.png')}}" alt="home" class="dark-logo" />
                        </b><span>
                        <!--This is dark logo text--><img src="{{asset('asset/plugins/images/eliteadmin-text.png')}}" alt="home" class="dark-logo" />
                        </span></a>
                </div>
                        ...
                        <ul class="dropdown-menu mailbox animated bounceInDown">
                            ...
                            <li>
                                <div class="message-center">
                                    <a href="#">
                                        <div class="user-img"> <img src="{{asset('asset/plugins/images/users/pawandeep.jpg')}}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                        <div class="mail-contnet">
                                            <h5>Pavan kumar</h5>
                                            <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                                    </a>
                                    <a href="#">
                                        <div class="user-img"> <img src="{{asset('asset/plugins/images/users/sonu.jpg')}}" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                        <div class="mail-contnet">
                                            <h5>Sonu Nigam</h5>
                                            <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                                    </a>
                                    <a href="#">
                                        <div class="user-img"> <img src="{{asset('asset/plugins/images/users/arijit.jpg')}}" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                        <div class="mail-contnet">
                                            <h5>Arijit Sinh</h5>
                                            <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
                                    </a>
                                    <a href="#">
                                        <div class="user-img"> <img src="{{asset('asset/plugins/images/users/pawandeep.jpg')}}" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                        <div class="mail-contnet">
                                            <h5>Pavan kumar</h5>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <div class="user-profile">
                    <div class="dropdown user-pro-body">
                        <div><img src="{{asset('asset/plugins/images/users/4.jpg')}}" alt="user-img" class="img-circle"></div>
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> <a href="index.html" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu"> E-commerce <span class="fa arrow"></span> <span class="label label-rouded label-custom pull-right">7</span></span></a>
                    ...
                    <div class="col-md-5 col-lg-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            ...
                            <ul class="list-inline m-t-30 text-center">
                                <li class="p-r-20">
                                    <h5 class="text-muted"><i class="fa fa-circle" style="color: #e0321b;"></i> Order</h5>
                                ...
                                <table class="table product-overview">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>#85457898</td>
                                            <td>
                                                <img src="{{asset('asset/plugins/images/chair.jpg')}}" alt="iMac" width="80">
                                            </td>
                                            <td>Rounded Chair</td>
                                            <td>20</td>
                                            <td>10-7-2017</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>#95457898</td>
                                            <td>
                                                <img src="{{asset('asset/plugins/images/chair2.jpg')}}" alt="iPhone" width="80">
                                            </td>
                                            <td>Wooden Chair</td>
                                            <td>25</td>
                                            <td>09-7-2017</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>#68457898</td>
                                            <td>
                                                <img src="{{asset('asset/plugins/images/chair3.jpg')}}" alt="apple_watch" width="80">
                                            </td>
                                            <td>Gray Chair</td>
                                            <td>12</td>
                                            <td>08-7-2017</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>#45457898</td>
                                            <td>
                                                <img src="{{asset('asset/plugins/images/chair4.jpg')}}" alt="mac_mouse" width="80">
                                            </td>
