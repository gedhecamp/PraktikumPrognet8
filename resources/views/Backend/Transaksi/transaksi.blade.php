            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">List Transaksi</h4> </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 12%">
                                                ...
                                                <div class="col-md-6">
                                                    <form style="float:left; margin-left:9px;" action="transaksi/{{$row->id}}" method="post">
                                                        {{ method_field('DELETE') }}
                                                        {{ csrf_field() }}
                                                        {{-- <a href="kurir/{{$row->id}}" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="ti-trash"></i></a> --}}
                                                        <button type="submit" style="padding: 10px 10px" class="btn btn-block btn-success btn-xs mt-1 mb-1" name="delete">
                                                            <i class="ti-check"></i>
                                                        </button>
                                                    </form>
                                                </div>
