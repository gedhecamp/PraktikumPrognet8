                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="stok" type="number" min="0" class="form-control" id="exampleInputuname" placeholder="123">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="berat" type="number" min="0" class="form-control" id="exampleInputuname" placeholder="123">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="harga" type="number" min="0" class="form-control" id="exampleInputuname" placeholder="153">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="rate" type="number" max="100" min="0" class="form-control" id="exampleInputuname" placeholder="35%">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 ">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="mymce" name="des"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/row-->
                                ...
                                <table class="table product-overview" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 17%">
                                                <div class="col-md-4">
                                                    <form method='get' action='produktambah/{{$row->id}}'>
                                                        {{ csrf_field() }}
