                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading"> Insert Courier</div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="courier" type="text" id="firstName" class="form-control" placeholder="Name"> </div>
                                                </div>
                                            </div> 
                                            <hr></div>
                                ...
                                <table class="table product-overview" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 12%">
                                                <div class="col-md-6">
                                                    <form method='get' action='kurir/{{$row->id}}/edit'>
                                                        @csrf
                                                        @method('GET')
                                                        {{-- <a href="kurir/{{$row->id}}/edit" class="text-inverse p-r-10" data-toggle="tooltip" title="Edit"><i class="ti-marker-alt"></i></a> --}}
                                                ...
                                                <div class="col-md-6">
                                                    <form method='post' action='kurir/{{$row->id}}'>
                                                        @csrf
                                                        @method('DELETE')
                                                        {{-- <a href="kurir/{{$row->id}}" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="ti-trash"></i></a> --}}
