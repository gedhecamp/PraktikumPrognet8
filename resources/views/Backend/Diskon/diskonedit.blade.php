                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="/diskon/{{$diskon->id}}" method="post">
                                        {{ method_field('PUT') }}
								        {{ csrf_field() }}
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="produk[]" class="select2 m-b-10 select2-multiple" multiple="multiple" data-placeholder="Product Name">
                                                            {{-- @foreach ($diskon as $all) --}}
                                                                <option value="{{$diskon->id_product}}" 
                                                                    {{-- @foreach($produk as $row) --}}
                                                                        {{-- @if ($all->id_product == $row->id) --}}
                                                                            {{'selected'}}		
                                                                        {{-- @endif --}}
                                                                    {{-- @endforeach --}}
                                                                >{{$diskon->product_name}}</option>
                                                            {{-- @endforeach --}}
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="percentage" type="number" max="100" min="0" id="firstName" class="form-control" placeholder="35%" value="{{$diskon->percentage}}"> </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label">Date Range</label>
                                                        <div class="input-daterange input-group" id="date-range">
                                                            <input type="input" class="form-control" name="start" placeholder="start" value="{{$diskon->start}}" />
                                                            <span class="input-group-addon bg-info b-0 text-white">to</span>
                                                            <input type="input" class="form-control" name="end" placeholder="end" value="{{$diskon->end}}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div> 
